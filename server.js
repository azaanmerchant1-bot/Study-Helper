...
app.post("/register", async function(req, res) {
    try {
        ...
        users.push({ email: email, password: await bcrypt.hash(password, 10), plan: "free" });
        writeUsers(users);
        res.setHeader("Set-Cookie", "studyai_email=" + encodeURIComponent(email) + "; Path=/; SameSite=Lax");
